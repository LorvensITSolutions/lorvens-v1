    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FFF6E5] via-[#FFF8EB] to-[#FFEFDB] text-[#1F1F1F] overflow-hidden">
      ...
      <section className="py-12 px-6 md:px-12 lg:px-20 relative">
        ...
        >
          ...
          {/* Cards - Unrolled Without .map for performance */}
          <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" variants={staggerContainer}>
            {cards.map((card, index) => (
              <motion.div
                key={card.id}
                className={`group relative p-8 rounded-3xl bg-gradient-to-br ${card.gradient} border border-orange-200/50 backdrop-blur-sm hover:border-orange-400/70 transition-all duration-300 flex flex-col justify-between h-full min-h-[280px] shadow-lg hover:shadow-2xl cursor-pointer overflow-hidden`}
              ...
              >
                ...
                <div className="relative z-10">
                  {/* Icon */}
                  <motion.div
                    className="w-16 h-16 flex items-center justify-center rounded-2xl bg-gradient-to-br from-white to-orange-50 border-2 border-orange-300/50 mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300"
                    variants={iconBounce}
                    whileHover="hover"
                  >
                    {card.icon}
      ...
      <section className="py-12 px-6 md:px-12 lg:px-20 text-center relative">
        ...
        >
          ...
          <motion.div className="mb-4 mt-0" variants={fadeInUp}>
            <motion.div
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-orange-100 to-yellow-100 rounded-full text-orange-800 font-semibold mb-4 shadow-md"
          ...
          {/* CTA Title */}
          <motion.h2 className="text-4xl md:text-5xl lg:text-7xl font-extrabold mb-6 leading-tight" variants={fadeInUp}>
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Transform your vision into reality with our cutting-edge digital solutions. Whether you're a startup dreaming big or an enterprise scaling new heights —
          ...
          <motion.div className="flex flex-col sm:flex-row gap-6 justify-center items-center" variants={fadeInUp}>
            <motion.div whileHover={{ scale: 1.08, y: -3 }} whileTap={{ scale: 0.98 }} transition={{ duration: 0.2 }}>
              <Link
                to="/contact"
                className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-orange-600 to-yellow-500 text-white font-bold text-lg rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden"
              >
                {/* Shimmer Effect */}
                <motion.div
            ...
            <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.98 }} transition={{ duration: 0.2 }}>
              <Link
                to="/projects"
                className="inline-flex items-center gap-3 px-8 py-4 bg-white/80 backdrop-blur-sm text-orange-600 font-semibold text-lg rounded-2xl border-2 border-orange-200 hover:border-orange-400 hover:bg-white transition-all duration-300 shadow-lg"
              >
          ...
          {/* Trust Indicators */}
          <motion.div className="mt-10 flex flex-wrap justify-center items-center gap-8 text-gray-500" variants={fadeInUp}>
            {[
